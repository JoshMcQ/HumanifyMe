...
Make AI sound like you. · [⭐ Star us on GitHub](https://github.com/JoshMcQ/HumanifyMe)
...
Before first use, run `npx -y humanifyme@0.2.2 setup` in a terminal. The wizard
...
from npm, pinned to the released version (`npx -y --package humanifyme@0.2.2
