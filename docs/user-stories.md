...
As a developer setting up HumanifyMe for the first time, I want to give the agent 3 to 10 of my real writing samples and have it build a voice profile in under a minute, so that future rewrites recognize my voice.
