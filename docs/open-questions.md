...
- **Status:** answered (2026-06-03).
- **Resolution:** Yes, via Ollama. Estimated effort: 3 to 5 days now that the provider abstraction is in place (revised down from the original 2-week estimate, which assumed a custom integration path).
