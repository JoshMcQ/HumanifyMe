...
5. Preserve placeholders like [EMAIL_1], [PHONE_1], [ADDRESS_1], [API_KEY_1], [CODE_1] verbatim. They will be restored after.
...
${args.directives.includes('shorter') ? 'Target 60-80% of the input length.' : 'Output length should be between 40% and 130% of input length. Padded AI drafts usually get much shorter; that is fine.'}${args.lengthReminder ? `\n\nIMPORTANT: ${args.lengthReminder}` : ''}`;
}
