...
> Note (2026-06-24): before the public launch, the public web stack (`site/`,
> `cf-worker/`, and the `e2e/` Playwright specs) was relocated to a private maintainer
> tree so the deployable go-to-market surface is not part of the open repository.
> Decisions D1, D6, D9, and D10 below are kept as historical record and refer to code
> that no longer lives in this repo.
